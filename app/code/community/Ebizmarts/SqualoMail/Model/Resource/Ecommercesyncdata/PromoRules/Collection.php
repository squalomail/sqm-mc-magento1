 ...
 */
class Ebizmarts_SqualoMail_Model_Resource_Ecommercesyncdata_PromoRules_Collection extends
    Ebizmarts_SqualoMail_Model_Resource_Ecommercesyncdata_Collection
{
    ...
    public function joinLeftEcommerceSyncData($preFilteredPromoRulesCollection, $columns = array('m4m.*'))
    {
        ...
        $preFilteredPromoRulesCollection->getSelect()->joinLeft(
            ...
            "m4m.related_id = main_table.entity_id AND m4m.type = '" . Ebizmarts_SqualoMail_Model_Config::IS_PROMO_RULE
