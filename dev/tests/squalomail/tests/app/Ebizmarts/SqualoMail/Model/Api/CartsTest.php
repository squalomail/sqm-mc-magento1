...
class Ebizmarts_SqualoMail_Model_Api_CartsTest extends PHPUnit_Framework_TestCase
{
    ...
    const SQUALOMAIL_STORE_ID = '3ade9d9e52e35e9b18d95bdd4d9e9a44';
    ...
    public function testCreateBatchJson()
    {
        ...
        $cartsApiMock->expects($this->once())->method('getSqualomailStoreId')->willReturn(self::SQUALOMAIL_STORE_ID);
    ...
    public function testCreateBatchJsonisAbandonedCartDisabled()
    {
        ...
        $quotesCollectionResource->expects($this->once())
            ->method('setSqualomailStoreId')->willReturn(self::SQUALOMAIL_STORE_ID);
    ...
    public function testGetModifiedQuotes()
    {
        ...
        $cartJson = '{"id":"692","customer":{"id":"GUEST-2018-11-30-20-00-07-96938700",'
            ...
            . '"campaign_id":"482d28ee12","checkout_url":"http:\/\/f3364930.ngrok.io\/squalomail\/cart'
        ...
        $allCarts = array(
            array(
                'method' => 'DELETE',
                'path' => '/ecommerce/stores/' . self::SQUALOMAIL_STORE_ID . '/carts/' . self::ALREADY_SENT_CART_ID,
    ...
    public function testGetNewQuotesNewQuote()
    {
        ...
        $cartJson = '{"id":"692","customer":{"id":"GUEST-2018-11-30-20-00-07-96938700",'
            ...
            . '"checkout_url":"http:\/\/f3364930.ngrok.io\/squalomail\/cart\/loadquote\?'
    ...
    public function testGetAllCartsByEmail()
    {
        ...
        $condition = "m4m.related_id = main_table.entity_id AND m4m.type = '"
            ...
            . "' AND m4m.squalomail_store_id = '" . self::SQUALOMAIL_STORE_ID . "'";
        $squalomailSelect = array('m4m.*');
        $where = "m4m.squalomail_sync_deleted = 0 AND m4m.squalomail_store_id = '" . self::SQUALOMAIL_STORE_ID . "'";
    ...
    public function testMakeCart()
    {
        $checkoutUrl = 'test';
        $isModified = false;
        $squalomailCampaignId = 'qwe123erq';
