...
class Ebizmarts_SqualoMail_Model_Adminhtml_Resendecommercedata_CommentTest extends PHPUnit_Framework_TestCase
{
    /**
     * @param array $data
    ...
    public function testGetCommentText($data)
    {
        ...
        $commentMock = $this->getMockBuilder(Ebizmarts_SqualoMail_Model_Adminhtml_Resendecommercedata_Comment::class)
            ->disableOriginalConstructor()
