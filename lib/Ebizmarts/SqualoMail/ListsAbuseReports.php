 ...
 */
class SqualoMail_ListsAbuseReports extends SqualoMail_Abstract
{
    /**
    ...
    public function getAll($listId, $fields = null, $excludeFields = null, $count = null, $offset = null)
    {
        ...
        return $this->_master->call('lists/' . $listId . '/abuse_reports', $_params, Ebizmarts_SqualoMail::GET);
    }
    ...
    public function get($listId, $reportId, $fields = null, $excludeFields = null, $count = null, $offset = null)
    {
        ...
        return $this->_master->call(
            'lists/' . $listId . '/abuse_reports/' . $reportId, $_params, Ebizmarts_SqualoMail::GET
        );
    }
}
